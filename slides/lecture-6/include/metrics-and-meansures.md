class: center, middle
# .red[Metrics] for Software Security Engineering
...
Based on Chapter 6 from Mead, N. R., & Woody, C. (2017). Cyber security engineering: A practical approach for systems and software assurance. Addison-Wesley.
...
???
In this world where wearable sensors provide many measurements, it is not clear how to interpret these numbers. In software projects, as simillar situation exists. Aligning the project context with the right metrics 
